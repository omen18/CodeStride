# Contributing to CodeStride

Thank you for your interest in contributing to CodeStride! Whether you are a GSSoC (GirlScript Summer of Code) participant or a general open-source contributor, we are thrilled to have you.
...
Click the **Fork** button at the top-right of the CodeStride repository.
...
```bash
git remote add upstream https://github.com/Umbrella-io/codestride.git
```
...
Before setting up CodeStride locally, make sure you have configured the following:
...
1. **Fork the Repo:** Click the "Fork" button at the top-right of the [CodeStride repository](https://github.com/Umbrella-io/codestride).
2. **Clone Your Fork:**
   ```bash
   git clone https://github.com/<your-username>/codestride.git
   cd codestride
...
4. Verify that your CodeStride dashboard loads successfully.
...
CodeStride relies on a set of environment variables to connect to external APIs and database services.
...
For guides on self-hosting CodeStride or deploying it manually, please refer to the Self-Hosting Documentation.

---

# 🚀 Thank You!

Thank you for helping make **CodeStride** better!
...
Answers to the most common questions from new contributors and GSSoC participants. If your question is not covered here, ask in [GitHub Discussions](https://github.com/omen18/codestride/discussions) or on the GSSoC Discord.
...
Browse [good first issues](https://github.com/omen18/codestride/issues?q=label%3A%22good+first+issue%22), read [docs/architecture.md](./docs/architecture.md), and pick a `gssoc:level1` or documentation issue if you are participating in GSSoC.
</details>
...
Always open PRs against **`main`** on the upstream repository (`omen18/codestride`). Never push directly to `main` on upstream — work on a feature branch in your fork instead.
</details>
...
<details>
<summary><strong>How do GSSoC points work for CodeStride?</strong></summary>
...
CodeStride runs ESLint and formatting checks before commits. See **[docs/HUSKY_TROUBLESHOOTING.md](./docs/HUSKY_TROUBLESHOOTING.md)** for step-by-step fixes, including permission errors on Linux/macOS and Windows-specific issues.
</details>
...
- **[GitHub Discussions](https://github.com/omen18/codestride/discussions)** — questions, ideas, and community help
...
- **[Open an issue](https://github.com/omen18/codestride/issues/new/choose)** — for bugs or unclear documentation
</details>
...
Thank you for helping make CodeStride better! Happy coding! 🚀
