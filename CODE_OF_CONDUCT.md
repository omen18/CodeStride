...
- All CodeStride contribution channels: GitHub Issues, Pull Requests, Discussions, and the
...
1. **Open a private GitHub Security Advisory** at
   <https://github.com/Umbrella-io/codestride/security/advisories/new> with the
   `gsoc-coc` label in the title. This keeps the report visible only to the maintainer.
2. **If the advisory form is unavailable**, email **yashrajsharan@gmail.com** with
