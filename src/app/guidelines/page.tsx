...
export const metadata: Metadata = {
    title: "Community Guidelines | CodeStride",
    description:
        "Guidelines and expectations for participating in the CodeStride community.",
};
        ...
        <main className="min-h-screen bg-[var(--background)]">
            <div className="max-w-5xl mx-auto py-8 px-4">
                ...
                <p className="text-[var(--muted-foreground)] mb-8">
                    CodeStride aims to maintain a welcoming, collaborative, and
                ...
                <div className="space-y-6">
                    {[
                        ...
                        },
                        {
                            ...
                            content:
                                "These guidelines are inspired by the project's Code of Conduct and Contributor Covenant principles. All participants are expected to follow them while engaging with the CodeStride community.",
                        },
                    ].map((section) => (
                        <div
                            key={section.title}
