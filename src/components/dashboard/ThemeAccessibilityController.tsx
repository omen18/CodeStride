...
export default function ThemeAccessibilityController() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const savedTheme = localStorage.getItem('codestride_theme') as 'light' | 'dark' | null;
      const savedContrast = localStorage.getItem('codestride_contrast') === 'true';
  ...
  const toggleTheme = () => {
    ...
    setTheme(nextTheme);
    localStorage.setItem('codestride_theme', nextTheme);
  ...
  const toggleContrast = () => {
    ...
    localStorage.setItem('codestride_contrast', String(nextContrast));
