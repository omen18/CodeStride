...
const COMMUNITY_LINKS = [
  { label: "Discussions", href: "https://github.com/omen18/codestride/discussions" },
  { label: "Issues", href: "https://github.com/omen18/codestride/issues" },
  { label: "GitHub Repository", href: "https://github.com/omen18/codestride" },
  { label: "Contributing Guide", href: "https://github.com/omen18/codestride/blob/main/CONTRIBUTING.md" },
];
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-7xl px-6 py-12 sm:px-8 lg:px-12">
        ...
        <div
          ...
          style={{ fontFamily: "var(--font-jetbrains, ui-monospace, monospace)" }}
        >
          <p>© {year} CodeStride. Built for open-source contributors.</p>
