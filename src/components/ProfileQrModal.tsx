...
interface ProfileQrModalProps {
  /** The full public profile URL to encode, e.g. https://codestride-silk-kappa.vercel.app/u/johndoe */
  profileUrl: string;
 ...
 *   {showQr && (
 *     <ProfileQrModal
 *       profileUrl={`https://codestride-silk-kappa.vercel.app/u/${username}`}
 *       username={username}
...
export function ProfileQrModal({
  ...
  const handleDownload = useCallback(() => {
    ...
    img.onload = () => {
      ...
      link.href = pngUrl;
      link.download = `codestride-${username}-qr.png`;
      link.click();
    };
