...
export default function BadgeSection({ username }: BadgeSectionProps) {
  ...
  const streakMarkdown = `![CodeStride Streak](${streakBadgeUrl})`;
  const commitsMarkdown = `![CodeStride Commits](${commitsBadgeUrl})`;
  ...
  return (
    <>
      ...
      <p className="mb-4 text-sm text-[var(--muted-foreground)]">
        Show off your CodeStride stats on your GitHub profile! Copy and paste the markdown below into your README.
      </p>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="mb-2">
            <Image src={streakBadgePreviewUrl} alt="CodeStride Streak" width={150} height={20} className="w-auto h-auto" unoptimized />
          </div>
        ...
        <div>
          ...
          <div className="mb-2">
            <Image src={commitsBadgePreviewUrl} alt="CodeStride Commits" width={150} height={20} className="w-auto h-auto" unoptimized />
          </div>
