  ...
  useEffect(() => {
    ...
    const startFallbackPolling = () => {
      ...
      fallbackIntervalRef.current = setInterval(() => {
        ...
        window.dispatchEvent(new CustomEvent("codestride:sync"));
        window.dispatchEvent(new CustomEvent("codestride:notifications"));
      }, 60000); // 60s polling
    };
            ...
            if (data.type === "update") {
              if (data.syncTriggered) {
                ...
                window.dispatchEvent(
                  new CustomEvent("codestride:sync", {
              ...
              if (typeof data.unreadCount === "number") {
                ...
                window.dispatchEvent(
                  new CustomEvent("codestride:notifications", {
