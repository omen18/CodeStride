    ...
    >
      ...
      <div style={{ flex: '1 1 340px', maxWidth: 500, position: 'relative', zIndex: 2 }}>
        ...
        <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
          ...
          <a
            href="https://github.com/omen18/codestride"
            target="_blank"
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ color: MUTED, fontSize: 16, lineHeight: 1.75, margin: '0 0 28px', maxWidth: 580 }}>
            CodeStride helps developers, open-source contributors, and teams understand how their GitHub work is moving. It brings activity, pull requests, streaks, goals, and public profile insights into one calm dashboard so new users can quickly see what the platform is for.
          </p>
...
const WHY_CODESTRIDE = [
  ...
  },
  {
    icon: Server,
    title: "Self-Hosting",
    desc: "Run CodeStride on your own infrastructure."
  }
];
    ...
    >
      ...
      <div style={{ maxWidth: 680, marginBottom: 40 }}>
        ...
        <p style={{ fontSize: 16, color: MUTED, lineHeight: 1.7, margin: 0 }}>   {/* was '#555' */}
          CodeStride is fully open source — MIT licensed, self-hostable, and built by developers
      ...
      <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
        <a
          href="https://github.com/omen18/codestride/issues?q=label%3A%22good+first+issue%22+is%3Aopen"
          target="_blank"
          rel="noopener noreferrer"
        ...
        <a
          href="https://github.com/omen18/codestride/blob/main/CONTRIBUTING.md"
          target="_blank"
          rel="noopener noreferrer"
          className="lnd-cta-secondary"
        >
        ...
        <a
          href="https://github.com/omen18/codestride/fork"
          target="_blank"
          rel="noopener noreferrer"
          className="lnd-cta-secondary"
        >
  ...
  return (
    ...
    >
      <span style={{ fontFamily: MONO, fontSize: 11, color: MUTED }}>
        © {new Date().getFullYear()} CODESTRIDE
      </span>
      <div style={{ display: 'flex', gap: 20 }}>
        {[
          { label: 'GitHub', href: 'https://github.com/omen18/codestride' },
          { label: 'CONTRIBUTING.md', href: 'https://github.com/omen18/codestride/blob/main/CONTRIBUTING.md' },
          { label: 'LICENSE', href: 'https://github.com/omen18/codestride/blob/main/LICENSE' },
          { label: 'Issues', href: 'https://github.com/omen18/codestride/issues' },
        ].map(l => (
