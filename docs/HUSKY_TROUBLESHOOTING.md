...
This guide helps GSSoC contributors resolve common Husky and Git hook issues encountered during local development on CodeStride.
...
Husky is a tool that runs scripts automatically before Git actions like `commit` and `push`. CodeStride uses Husky to enforce:
...
- Open a [GitHub Discussion](https://github.com/omen18/codestride/discussions)
