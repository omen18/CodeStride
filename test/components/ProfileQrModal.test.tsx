...
describe("ProfileQrModal", () => {
  const defaultProps = {
    ...
    onClose: vi.fn(),
    username: "john_doe",
    profileUrl: "https://codestride.mock/u/john_doe",
  };
  ...
  it("renders modal content when isOpen is true", () => {
    ...
    expect(
      screen.getByText(/Scan with a phone camera to quickly view @john_doe's profile on CodeStride/i)
    ).toBeInTheDocument();
  ...
  it("triggers download of QR code when download button is clicked", () => {
    ...
    expect(linkMock.download).toBe("john_doe-codestride-qr.png");
