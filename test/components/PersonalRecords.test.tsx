...
describe("PersonalRecords Confetti", () => {
  ...
  it("does not trigger confetti on the first session load", async () => {
    ...
    await waitFor(() => {
      ...
      expect(sessionStorage.getItem("codestride_records_test-account_longest_streak")).toBe("5");
      expect(sessionStorage.getItem("codestride_records_test-account_best_day")).toBe("10");
    });
  ...
  it("triggers confetti when a record improves during the session", async () => {
    ...
    sessionStorage.setItem("codestride_records_test-account_longest_streak", "3");
    sessionStorage.setItem("codestride_records_test-account_best_day", "8");
  ...
  it("does not trigger confetti if records are equal or lower", async () => {
    ...
    sessionStorage.setItem("codestride_records_test-account_longest_streak", "5");
    sessionStorage.setItem("codestride_records_test-account_best_day", "12");
